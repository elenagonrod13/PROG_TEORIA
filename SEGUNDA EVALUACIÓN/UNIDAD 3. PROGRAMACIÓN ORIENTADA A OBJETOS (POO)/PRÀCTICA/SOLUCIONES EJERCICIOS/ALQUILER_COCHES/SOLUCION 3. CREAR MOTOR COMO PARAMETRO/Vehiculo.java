package poo_alquilerCoches_Motor__Como_Parámetro;
...
public class Vehiculo {
	...
	public Vehiculo(String matricula, int plazas, Motor caracteristicasMotor) {
		reservado=false;
		setMatricula(matricula);
		setPlazas(plazas);
		setCaracteristicasMotor(caracteristicasMotor);
	}
